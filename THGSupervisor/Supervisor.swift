...
public class Supervisor: UIResponder {
    ...
    public func loadPlugin(plugin: Pluggable?) {
        let bundleID = "com.walmart.electronics" //NSBundle.mainBundle().bundleIdentifier
        if let plugin = plugin {
            plugin.initializeForContainer(bundleID)
            
            NSLog("plugin = \(plugin.identifier)")
    ...
    public func reorderByDependencies() {
